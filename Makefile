...
test: main.cpp ppm.cpp log.cpp brandonM.cpp brandonP.cpp abdulelahA.cpp jinxuH.cpp andyK.cpp 
	g++ $(CFLAGS) main.cpp ppm.cpp log.cpp jinxuH.cpp andyK.cpp brandonM.cpp brandonP.cpp abdulelahA.cpp libggfonts.a /usr/lib/x86_64-linux-gnu/libopenal.so /usr/lib/x86_64-linux-gnu/libalut.so -D RENDERTEST -D USE_OPENAL_SOUND -Wall -Wextra $(LFLAGS) -o test
